...
def Conv2d(net, n_filter=32, filter_size=(3, 3), strides=(1, 1), act = None,
        padding='SAME', W_init = tf.compat.v1.truncated_normal_initializer(stddev=0.02), b_init = tf.constant_initializer(value=0.0),
...
def DeConv2d(net, n_out_channel = 32, filter_size=(3, 3),
        ...
        W_init = tf.compat.v1.truncated_normal_initializer(stddev=0.02), b_init = tf.constant_initializer(value=0.0),
